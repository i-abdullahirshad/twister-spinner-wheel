      ...
      <div className="max-w-4xl mx-auto py-12 md:py-16 px-6">
        ...
        <div className="space-y-6 text-foreground/80 leading-relaxed">
          ...
          <ul className="list-disc pl-6 space-y-3">
            ...
            <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Privacy Policy) refers to Twister Spinner.</li>
          ...
          <h4 className="text-lg font-bold text-foreground mt-4 mb-2">Personal Data</h4>
          <p>
            While using Our Service, We may ask You to provide Us with certain personally identifiable information that can be used to contact or identify You. Personally identifiable information may include, but is not limited to:
          </p>

          <h4 className="text-lg font-bold text-foreground mt-6 mb-2">Usage Data</h4>
          ...
          <h3 className="text-xl font-semibold text-foreground mt-8 mb-3">Tracking Technologies and Cookies</h3>
          <p>
          ...
          <div className="space-y-4 mt-4">
            <div className="bg-card p-5 rounded-xl border border-border">
              <h4 className="font-bold text-foreground mb-1">Necessary / Essential Cookies</h4>
              <p className="text-sm mb-2">Type: Session Cookies | Administered by: Us</p>
            ...
            <div className="bg-card p-5 rounded-xl border border-border">
              <h4 className="font-bold text-foreground mb-1">Cookies Policy / Notice Acceptance Cookies</h4>
              <p className="text-sm mb-2">Type: Persistent Cookies | Administered by: Us</p>
              <p className="text-sm">Purpose: These Cookies identify if users have accepted the use of cookies on the Website.</p>
            </div>

            <div className="bg-card p-5 rounded-xl border border-border">
              <h4 className="font-bold text-foreground mb-1">Functionality Cookies</h4>
              <p className="text-sm mb-2">Type: Persistent Cookies | Administered by: Us</p>
          ...
          <h3 className="text-xl font-semibold text-foreground mt-8 mb-3">Use of Your Personal Data</h3>
          ...
          <h3 className="text-xl font-semibold text-foreground mt-8 mb-3">Retention of Your Personal Data</h3>
          <p>
          ...
          <h4 className="text-lg font-bold text-foreground mt-4 mb-2">Account Information</h4>
          ...
          <h4 className="text-lg font-bold text-foreground mt-4 mb-2">Usage Data</h4>
          <ul className="list-disc pl-6 space-y-2">
            <li><strong>Website analytics data</strong> (cookies, IP addresses, device identifiers): up to 24 months from the date of collection, which allows us to analyze trends while respecting privacy principles.</li>
            <li><strong>Server logs</strong> (IP addresses, access times): up to 24 months for security monitoring and troubleshooting purposes.</li>
          </ul>
          <p className="mt-4">
          ...
          <h3 className="text-xl font-semibold text-foreground mt-8 mb-3">Transfer of Your Personal Data</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold text-foreground mt-8 mb-3">Delete Your Personal Data</h3>
          ...
          <h3 className="text-xl font-semibold text-foreground mt-8 mb-3">Disclosure of Your Personal Data</h3>
          <h4 className="text-lg font-bold text-foreground mt-4 mb-2">Business Transactions</h4>
          <p>
            If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.
          </p>

          <h4 className="text-lg font-bold text-foreground mt-4 mb-2">Law enforcement</h4>
          <p>
            Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).
          </p>

          <h4 className="text-lg font-bold text-foreground mt-4 mb-2">Other legal requirements</h4>
          ...
          <h3 className="text-xl font-semibold text-foreground mt-8 mb-3">Security of Your Personal Data</h3>
          <p>
