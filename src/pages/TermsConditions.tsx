    ...
    <div className="min-h-screen bg-background text-foreground font-sans selection:bg-primary/30 transition-colors duration-300">
      ...
      <div className="max-w-4xl mx-auto py-12 md:py-16 px-6">
        ...
        <div className="space-y-6 text-foreground/80 leading-relaxed">
          ...
          <h3 className="text-xl font-semibold text-foreground mt-6 mb-3">Interpretation</h3>
          <p>
            The words whose initial letters are capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.
          </p>

          <h3 className="text-xl font-semibold text-foreground mt-6 mb-3">Definitions</h3>
          <p>For the purposes of these Terms and Conditions:</p>
          <ul className="list-disc pl-6 space-y-3">
            <li><strong>Affiliate</strong> means an entity that controls, is controlled by, or is under common control with a party, where "control" means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.</li>
            <li><strong>Country</strong> refers to: Pakistan</li>
            <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in these Terms and Conditions) refers to Twister Spinner.</li>
            ...
            <li><strong>Website</strong> refers to Twister Spinner, accessible from <a href="https://twister-spinner.com/" className="text-primary hover:underline">https://twister-spinner.com/</a></li>
          ...
          {/* Section: Links from a Third-Party Social Media Service */}
          <h2 className="text-2xl font-bold text-foreground mt-12 mb-4 border-b border-border pb-2">
          ...
          {/* Section: For European Union (EU) Users */}
          <h2 className="text-2xl font-bold text-foreground mt-12 mb-4 border-b border-border pb-2">
          ...
          {/* Section: United States Legal Compliance */}
          <h2 className="text-2xl font-bold text-foreground mt-12 mb-4 border-b border-border pb-2">
